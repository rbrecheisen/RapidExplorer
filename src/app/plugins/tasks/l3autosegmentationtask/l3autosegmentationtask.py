...
class L3AutoSegmentationTask(Task):
    def __init__(self) -> None:
        ...
        self.addSetting(TaskFileSetting(name='inputData', displayName='Input Data'))
        self.addSetting(TaskFileSetting(name='tensorFlowModelFiles', displayName='TensorFlow Model Files'))
